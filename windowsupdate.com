<!DOCTYPE html>
<html i18n-values="dir:textdirection;.style.fontSize:fontsize" dir="ltr" style="font-size: 75%;"><head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0,
                                 maximum-scale=1.0, user-scalable=no">
  <title i18n-content="title">http://windowsupdate.com/ is not available</title>
...
<body id="t" i18n-values=".style.fontFamily:fontfamily" jstcache="0" style="font-family: sans, Arial, sans-serif;">
  <div id="main-frame-error" class="interstitial-wrapper" jstcache="0">
    <img class="icon icon-generic" jseval="updateIconClass(this.classList, iconClass)" jstcache="1">
    <div id="main-message" jstcache="0">
      <h1 i18n-content="heading" jstcache="0">This web page is not available</h1>
    ...
    <div id="help-box-outer" class="hidden" jstcache="0">
      <div id="details" jstcache="0">
        <div jsselect="summary" jstcache="5">
          <span jsvalues=".innerHTML:msg" jstcache="12">The server at <strong jscontent="hostName" jstcache="18">windowsupdate.com</strong> can't be found because the DNS look-up failed. DNS is the network service that translates a website's name to its Internet address. This error is most often caused by having no connection to the Internet or a misconfigured network. It can also be caused by an unresponsive DNS server or a firewall preventing <span jscontent="productName" jstcache="19">Chromium</span> from accessing the network.</span>
        </div>
        ...
        devices you may be using.</div>
          ...
          <div class="suggestion-header" jsvalues=".innerHTML:header" jstcache="13">Check your DNS settings</div>
          <div class="suggestion-body" jsvalues=".innerHTML:body" jstcache="14">Contact your network administrator if you're not sure what this means.</div>
        </div><div class="suggestions" jsselect="suggestions" jstcache="6" jsinstance="2">
          <div class="suggestion-header" jsvalues=".innerHTML:header" jstcache="13">Try disabling network prediction</div>
          <div class="suggestion-body" jsvalues=".innerHTML:body" jstcache="14">Go to
          the Chromium menu &gt;
          <span jscontent="settingsTitle" jstcache="20">Settings</span>
          &gt;
          <span jscontent="advancedTitle" jstcache="21">+ Show advanced settings</span>
          and deselect "<span jscontent="noNetworkPredictionTitle" jstcache="22">Predict network actions to improve page load performance</span>."
          If this does not resolve the issue, we recommend selecting this option
          again for improved performance.</div>
        </div><div class="suggestions" jsselect="suggestions" jstcache="6" jsinstance="3">
          <div class="suggestion-header" jsvalues=".innerHTML:header" jstcache="13">Allow Chromium to access the network in your firewall or antivirus
        settings.</div>
          <div class="suggestion-body" jsvalues=".innerHTML:body" jstcache="14">If it is already listed as a programme that is allowed to access the network, try
        removing it from the list and adding it again.</div>
        </div><div class="suggestions" jsselect="suggestions" jstcache="6" jsinstance="*4">
          <div class="suggestion-header" jsvalues=".innerHTML:header" jstcache="13">If you use a proxy server...</div>
          <div class="suggestion-body" jsvalues=".innerHTML:body" jstcache="14">Check your proxy settings or contact your network administrator to
        ...
        <div class="error-code" jscontent="errorCode" jstcache="9">Error code: ERR_NAME_NOT_RESOLVED</div>
      </div>
    </div>
  </div>
  <div id="sub-frame-error" jstcache="0">
    ...
    <img class="icon icon-generic" jseval="updateIconClass(this.classList, iconClass)" jsvalues=".title:errorDetails" jstcache="2" title="Unable to resolve the server's DNS address.">
    <div id="sub-frame-error-details" jsvalues=".innerHTML:errorDetails" jstcache="3">Unable to resolve the server's DNS address.</div>
  </div>
...
</script><script jstcache="0">loadTimeData.data = {"details":"Details","errorCode":"Error code: DNS_PROBE_POSSIBLE","errorDetails":"Waiting for DNS probe.","fontfamily":"sans, Arial, sans-serif","fontsize":"75%","heading":"This web page is not available","hideDetails":"Hide details","iconClass":"icon-generic","reloadButton":{"msg":"Reload","reloadTrackingId":-1,"reloadUrl":"http://windowsupdate.com/"},"suggestions":[],"summary":{"failedUrl":"http://windowsupdate.com/","hostName":"windowsupdate.com","msg":"Unable to look up\n        \u003Cstrong jscontent=\"hostName\">\u003C/strong>.\n        Trying to diagnose the problem...","productName":"Chromium"},"textdirection":"ltr","title":"http://windowsupdate.com/ is not available"};</script><script jstcache="0">// Copyright (c) 2012 The Chromium Authors. All rights reserved.
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.
